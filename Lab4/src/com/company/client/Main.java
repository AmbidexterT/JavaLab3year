...
import com.company.stockList.TechnicalItem;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        GenericItem genericItem1 = new GenericItem("Powerbank", 5000.0f, Category.GENERAL);
        GenericItem genericItem2 = new GenericItem("Samsung", 10000000000.00f, Category.GENERAL);
        GenericItem genericItem3 = new GenericItem("Notebook", 1.0f, Category.GENERAL);

        Date date = new Date();
        short expires = 10;
        short warrantyTime = 25;

        FoodItem foodItem1 = new FoodItem("cheease", 10.0f, null, Category.FOOD, date, expires);
        FoodItem foodItem2 = new FoodItem("sausage", 5.0f, foodItem1, Category.FOOD, date, expires);
        TechnicalItem technicalItem1 = new TechnicalItem(11, "technic", 1000.0f, null, Category.GENERAL, warrantyTime);
        FoodItem foodItem3 = new FoodItem("pineapple", 5.0f, expires);
