...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        GenericItem genericItem1 = new GenericItem(1, "Powerbank", 5000.0f, Category.GENERAL, null);
        GenericItem genericItem2 = new GenericItem(2, "Samsung", 10000000000.00f, Category.GENERAL, null);
        GenericItem genericItem3 = new GenericItem(3, "Notebook", 1.0f, Category.GENERAL, genericItem2);
        ...
        FoodItem foodItem1 = new FoodItem(4, "cheese", 10.0f, null, Category.FOOD, date, expires);
        FoodItem foodItem2 = new FoodItem(5, "sausage", 5.0f, foodItem1, Category.FOOD, date, expires);
